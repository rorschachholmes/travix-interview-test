...
*Changes in pom.xml* :
1. Changed Spring Boot version to 2.1.0 to leverage Spring 5 capabilities
2. Changed to webflux dependency to enable reactive programming.
3. Added Lombok dependency to avoid boilerplate code for getters and setters.
4. Added bean validation dependencies.
5. Added reactor-test dependencies to test reactive code.
